...
| Final alignment commit | سيُسجل في تقرير التسليم بعد هذا التحديث التوثيقي الطبيعي |
| Final HEAD / origin parity | سيُتحقق منهما بعد push التوثيق النهائي |
| Working tree | سيُتحقق من نظافته بعد push التوثيق النهائي |
