...
هذه الوثيقة هي بوابة الإطلاق الحالية بعد تدقيق Phase 17.9. وهي تميّز بين ما تم التحقق منه فعليًا، وما هو جاهز للتحقق الخارجي، وما يحتاج إعدادًا من مالك البنية التحتية. لا تمنح هذه الوثيقة صلاحية لتنفيذ migrations أو seed أو Production mutations أو تغيير الأسرار.
