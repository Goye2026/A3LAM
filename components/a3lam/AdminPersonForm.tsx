...
export function AdminPersonForm({ copy, categories, record, personId, mediaStatus, mediaProviderState, currentMedia }: { copy: FoundationMessages; categories: Category[]; record?: PersonRecord; personId?: string; mediaStatus: MediaStatus; mediaProviderState: "configured" | "not_configured" | "invalid_configuration"; currentMedia?: MediaAsset | null }) {
  ...
  return (
    <div className="admin-editor-layout">
      <nav className="admin-editor-outline" aria-label={copy.adminBiography}>
        <a href="#admin-basic-title">{copy.adminBasicInformation}</a>
        <a href="#admin-biography-title">{copy.adminBiography}</a>
        <a href="#admin-categories-title">{copy.adminCategories}</a>
        <a href="#admin-sources-title">{copy.adminSources}</a>
        <a href="#admin-timeline-title">{copy.adminTimeline}</a>
        <a href="#admin-education-title">{copy.adminEducation}</a>
        <a href="#admin-readiness-title">{copy.adminReadinessTitle}</a>
      </nav>
      ...
      <section className="admin-form-section" aria-labelledby="admin-basic-title">
        ...
        <div className="admin-form-grid">
          ...
          <label id="admin-biography-title" className="admin-form-wide">{copy.adminShortBio}<textarea className="admin-input" rows={3} value={form.shortBio} onChange={(event) => update("shortBio", event.target.value)} /></label>
      ...
      <section id="admin-readiness-section" className="admin-form-section admin-readiness-panel" aria-labelledby="admin-readiness-title">
      ...
      <section id="admin-categories-section" className="admin-form-section" aria-labelledby="admin-categories-title">
      ...
      <section id="admin-sources-section" className="admin-form-section" aria-labelledby="admin-sources-title">
      ...
      <section id="admin-timeline-section" className="admin-form-section" aria-labelledby="admin-timeline-title">
      ...
      <section id="admin-education-section" className="admin-form-section" aria-labelledby="admin-education-title">
      ...
      <div className="admin-form-actions">
        ...
        <span aria-live="polite" className={`admin-form-feedback admin-save-state${isDirty ? " is-dirty" : feedback ? " is-saved" : ""}`}>{busy ? copy.adminSaving : feedback || error || (isDirty ? copy.editorUnsaved : "")}</span>
      </div>
      </form>
    </div>
  );
