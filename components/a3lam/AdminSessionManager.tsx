...
export function AdminSessionManager({ initialItems, copy, canRevoke, currentSessionId }: { initialItems: AdminSessionSummary[]; copy: FoundationMessages; canRevoke: boolean; currentSessionId: string | null }) {
