...
export default async function RolesPage() {
  ...
  if (!principal || !(await hasEffectiveAdminPermission(principal, "roles.read"))) return <div className="admin-route"><p className="admin-alert" role="alert">{copy.adminUnauthorized}</p></div>;
