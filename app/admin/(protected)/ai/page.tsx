...
import { AiPersistenceUnavailableError, getAdminAiDocumentPrivateDetail, listAdminAiDocuments, listAdminAiFacts } from "@/lib/ai/persistence";
...
export default async function AdminAiPage({ searchParams }: PageProps) {
  ...
  try {
    ...
    persistenceUnavailable = error instanceof AiPersistenceUnavailableError;
  }
  ...
  const persistenceLabel = persistenceUnavailable ? copy.adminAiRequiresMigration : copy.adminAvailable;
