...
export default async function EditorsPage() {
  ...
  if (!principal || !(await hasEffectiveAdminPermission(principal, "editors.read"))) return <div className="admin-route"><p className="admin-alert" role="alert">{copy.adminUnauthorized}</p></div>;
